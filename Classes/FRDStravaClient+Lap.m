                     ...
                     failure:(void (^)(NSError *error))failure
{
    ...
    [manager GET:[NSString stringWithFormat:@"activities/%ld/laps", (long)activityId] parameters:@{ @"access_token" : self.accessToken} progress:nil success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject) {
